...
public class Constants {
	...
	public static final String GET_CLASS_COURSE = "select distinct class.id,col.course_id,class.updated_at from class class inner join collection col on col.course_id = class.course_id where class.updated_at > to_timestamp(?,'YYYY-MM-DD HH:MI:SS') - interval '3 minutes';";
